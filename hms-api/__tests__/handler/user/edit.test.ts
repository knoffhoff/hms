...
import UserEditResponse from '../../../src/rest/UserEditResponse';
import NotFoundError from '../../../src/error/NotFoundError';
import UserEditRequest from '../../../src/rest/UserEditRequest';
import ReferenceNotFoundError from '../../../src/error/ReferenceNotFoundError';

const mockEditUser = jest.fn();
jest.spyOn(userService, 'editUser')
    .mockImplementation(mockEditUser);
